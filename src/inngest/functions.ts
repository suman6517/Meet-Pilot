...
`.trim(),
model: openai({model:"gpt-4o" , apiKey:process.env.GROQ_AI_API_KEY }),
})
...
export const meetingsProcessing = inngest.createFunction(
    ...
    async ({event , step}) => {
        ...
        // The Above response and the transcript might be a problem in production , we need to handle it properly.And the solution is in below.
